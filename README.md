...
Находясь на ветке SDN, отредактируем файл S1. Мы обозначим и закоммитим изменения. Поскольку мы находимся на SDN, только она SDN сдвинется вверх в новый коммит:
